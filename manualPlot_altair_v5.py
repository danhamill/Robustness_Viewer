...
scaleFactors = [84,86,88,90,92,94,96,98,100,102,104,106,108,110,120]
...
for scaleFactor in scaleFactors:
    ...
    output_path = os.path.join(output_dir, f"{patternYear}_{scaleFactor}_{arc_spillway_config}_{dataset}_Alt3_noMix.png")
